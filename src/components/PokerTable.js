...
class PokerTable extends Component{
	...
	gameSet(){
		var finalPlayerHand = this.state.playersHand;
		var finalDealerHand = this.state.dealerHand;
		var finalCommunityCards = this.state.communityCards;
		var finalPlayerHandWithCommunity = finalPlayerHand.push(finalCommunityCards);
		var finalDealerHandWithCommunity = finalDealerHand.push(finalCommunityCards);
		console.log(finalPlayerHandWithCommunity);
		console.log(finalDealerHandWithCommunity);
		for(let i = 0; i < finalPlayerHandWithCommunity.length; i++){
			finalPlayerHandWithCommunity[i]
		}
